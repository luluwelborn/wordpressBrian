...
if ( ! function_exists( 'photo_magic_featured_slider_array' ) ) :
    ...
    function photo_magic_featured_slider_array( $from_slider ){
        ...
        $photo_magic_feature_slider_contents_array[0]['photo-magic-fs-title'] = __('<span>Welcome </span> to photo-magic','photo-magic');
        $photo_magic_feature_slider_contents_array[0]['photo-magic-fs-content'] = __("Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s",'photo-magic');
        $photo_magic_feature_slider_contents_array[0]['photo-magic-fs-link'] = '#';
        $photo_magic_feature_slider_contents_array[0]['photo-magic-fs-image'] = get_template_directory_uri()."/assets/img/banner.jpg";
    ...
    <?php }  ?>
        ...
        >
            ...
            foreach( $photo_magic_slider_arrays as $photo_magic_slider_array ){
                ...
                if(empty($photo_magic_slider_array['photo-magic-fs-image'])){
                    $photo_magic_feature_slider_image = get_template_directory_uri().'/assets/img/banner.jpg';
                }
                else{
