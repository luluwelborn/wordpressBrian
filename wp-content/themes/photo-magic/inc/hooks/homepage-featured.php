...
if ( ! function_exists( 'photo_magic_home_featured_array' ) ) :
    ...
    function photo_magic_home_featured_array( $from_featured ){
        ...
        $photo_magic_home_featured_contents_array[1]['photo-magic-home-featured-title'] = __('A Beautiful Palace', 'photo-magic');
        $photo_magic_home_featured_contents_array[1]['photo-magic-home-featured-content'] = __("Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum 1500.", 'photo-magic');
        $photo_magic_home_featured_contents_array[1]['photo-magic-home-featured-link'] = '#';
        $photo_magic_home_featured_contents_array[1]['photo-magic-home-featured-page-image'] = get_template_directory_uri()."/assets/img/no-image-feature.jpg";
        ...
        if ( 'from-category' ==  $from_featured ){
            ...
            if( 0 != $photo_magic_home_featured_category ){
